...
import SendConsoleLog1WhenCustomerIsCreatedHandler from "../../domain/event/customer/handler/send-console-log-1-when-customer-is-created.handler";
import SendConsoleLog2WhenCustomerIsCreatedHandler from "../../domain/event/customer/handler/send-console-log-2-when-customer-is-created.handler";
import SendConsoleLogWhenCustomerAddressIsChangedHandler from "../../domain/event/customer/handler/send-console-log-when-customer-address-changed.handler";
